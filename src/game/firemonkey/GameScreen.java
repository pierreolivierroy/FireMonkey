			...
			if (event.type == TouchEvent.TOUCH_DRAGGED
				...
				if (world.monkey.state != Monkey.PLAYER_STATE_BONUS
					...
					if (world.monkey.firstJump) {
						...
						world.activeExplosions.add(new Explosion(30,
								(int) world.monkey.position.x,
								(int) world.monkey.position.y
										+ (int) Monkey.PLAYER_HEIGHT, 3.0f));
						world.monkey.velocity.y = 30;
						world.monkey.jump--;
